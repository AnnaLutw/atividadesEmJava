...
class Eletrodomestico {
	...
	//coloquei as informações no construtor
	public Eletrodomestico(String [] info){
		nomeLoja = info[0]; //nome da loja no 0
		preco = Double.parseDouble(info[1]); //preço no 1
...
public class ativi3 {
	...
	public static double media (Eletrodomestico[]dados) {
		double conta=0;
		//pregando o preço e em i e salvando em conta
	...
	public static void main(String[] args)  {
		...
		try {
			...
			arquivo.write("MEDIA É: " + conta +"\n");
			arquivo.write("LOJAS ABAIXO DA MEDIA: " + "\n");

			//se o preço for menor que a media, vai salvar imprimir no arquivo o nome da loja, o preço e o numero dessa loja abaixo da media.
			for(int j = 0;j < 15; j++) {
